...
public class JobListing {
    ...
    public boolean addNewJob(String jobName, String jobDescription, double jobSalary){

        int id = jobListings.size();
        jobListings.add(new JobListing(id + 2, jobName, jobDescription, jobSalary, ""));

        if(id < jobListings.size()){
